...
( function( factory ) {
	...
	( function( $ ) {
		...
		var Repeater = function( element, options ) {
			...
			this.$element.find('.centerProgressBar').remove();
			...
			this.$updateBtn = this.$element.find('.update');
			...
			this.$updateBtn.on('click.fu.repeater', $.proxy( this.update, this));
					...
					nested: [ { //RENDERING THEAD
						...
						nested: [ { //RENDERING COLUMN HEADERS (TH AND REPEATER-LIST-HEADING)
							render: function( helpers, callback ) {
								...
								var $item = $( '<th></th>' ).addClass('text-center');
								var self = this;
						...
						nested: [ { //RENDERING ROWS (TR)
							...
							nested: [ { //RENDERING COLUMNS (TD)
								...
								render: function( helpers, callback ) {
									...
									if($.isNumeric(content.replace(/,/g, ''))){
